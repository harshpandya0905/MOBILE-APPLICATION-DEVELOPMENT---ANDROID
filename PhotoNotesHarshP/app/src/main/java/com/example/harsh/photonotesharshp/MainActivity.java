package com.example.harsh.photonotesharshp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String key1 = "com.example.harsh.photonotesharshp.caption111";
    public static final String key2 = "com.example.harsh.photonotesharshp.filepath111";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.item1){
            ...
            intent.setData(Uri.parse("package:com.example.harsh.photonotesharshp"));
